...
2. **Layout Shell + Search Relocation (P0) (P0):** Add collapsible drawer, hide sidebar on mobile, Move into drawer, add header trigger. - search.tsx - header.tsx, left-sidebar-menu.tsx
3. **Cards, Grids, Descriptions (P0):** Adjust to one-column layouts. - latest-transactions.tsx, latest-blocks.tsx, transactions-builder.tsx
4. **Tables (P1):** Add scroll or stacked layout for mobile. - transactions-table.tsx
5. **Forms & Touch Targets (P1):** Improve spacing and clickability. - switch.tsx, transaction-builder.tsx
6. **Overlays (P2):** Convert modals into adaptive sheets. - transaction-builder.tsx
7. **Typography (P3):** Retain as-is; ensure scale consistency.
